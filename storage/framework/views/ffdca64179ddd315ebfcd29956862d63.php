        ...
        <div class="mt-16">
            <div class="row">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3">
                        <div class="card">
                            <img class="card-img-top" src="<?php echo e($item->img_thumbnail); ?>" alt="Card image">
                            <div class="card-body">
                                <h4 class="card-title"><?php echo e(\Str::limit($item->name, 30)); ?></h4>
                                <a href="<?php echo e(route('product.detail', $item->slug)); ?>" class="btn btn-primary">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\xuong-laravel-main\xuong-laravel-main\resources\views/welcome.blade.php ENDPATH**/ ?>