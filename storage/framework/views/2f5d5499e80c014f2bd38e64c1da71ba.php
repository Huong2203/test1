<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startSection('title'); ?>
        <title><?php echo e($model->title); ?> / Reader</title>
                ...
                <div class=" col-lg-9   mb-5 mb-lg-0">
                    <article>
                        <div class="post-slider mb-4">
                            <img src="<?php echo e(Storage::url($model->image)); ?>" class="card-img" alt="post-thumb">
                        </div>

                        <h1 class="h2"><?php echo e($model->title); ?></h1>
                        <ul class="card-meta my-3 list-inline">
                            <li class="list-inline-item">
                                <a href="author-single.html" class="card-meta-author">
                                    <img src="<?php echo e(Storage::url($model->user->cover)); ?>">
                                    <span><?php echo e($model->user->name); ?></span>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <i class="ti-timer"></i><?php echo e(date('H:i:s', strtotime($model->created_at))); ?>

                            </li>
                            <li class="list-inline-item">
                                <i class="ti-calendar"></i><?php echo e(date('d/m/Y', strtotime($model->created_at))); ?>

                            </li>
                            <li class="list-inline-item">
                                <ul class="card-meta-tag list-inline">
                                    <li class="list-inline-item"><a href="tags.html"><?php echo e($model->tag->name); ?></a></li>
                                </ul>
                            </li>
                        </ul>
                        <div class="content">
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\WebNews\xuong-laravel-main\resources\views/articles-detail.blade.php ENDPATH**/ ?>