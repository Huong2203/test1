        ...
        <div class="container">
            <div class="row">
                <div
                    ...
                    <h1 class="h2 mb-4">Search items from <mark><?php echo e($search); ?></mark></h1>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="card mb-4">
                            <div class="card-body">
                                <h3 class="mb-3">
                                    <a href="<?php echo e(route('articles.detail', ['slug' => $item->slug])); ?>">
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\WebNews\Laravel\resources\views/search.blade.php ENDPATH**/ ?>