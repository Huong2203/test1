            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarCatalogues">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.catalogues.index')); ?>" class="nav-link"
                                   data-key="t-horizontal">Danh sách</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.catalogues.create')); ?>" class="nav-link"
                                   data-key="t-horizontal">Thêm mới</a>
                            </li>
                        </ul>
                    </div>
...
<!-- Left Sidebar End -->
<?php /**PATH C:\laragon\www\xuong-laravel-main\xuong-laravel-main\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>
