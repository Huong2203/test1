...
@section('content')
    ...
    @section('title')
        <title>{{ $model->title }} / Reader</title>
    @endsection
                        ...
                        <ul class="card-meta my-3 list-inline">
                            <li class="list-inline-item">
                                <a href="author-single.html" class="card-meta-author">
                                    <img src="{{ Storage::url($model->user->cover) }}">
                                    <span>{{ $model->user->name }}</span>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <i class="ti-timer"></i>{{ date('H:i:s', strtotime($model->created_at)) }}
                            </li>
                            <li class="list-inline-item">
                                <i class="ti-calendar"></i>{{ date('d/m/Y', strtotime($model->created_at)) }}
                            </li>
                            <li class="list-inline-item">
                                <ul class="card-meta-tag list-inline">
                                    <li class="list-inline-item"><a href="tags.html">{{ $model->tag->name }}</a></li>
                                </ul>
                            </li>
                        </ul>
                        <div class="content">
