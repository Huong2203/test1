                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img
                                                            src="{{ asset('theme/admin/assets/images/articles/img-1.png') }}"
                                                            alt=""
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img
                                                            src="{{ asset('theme/admin/assets/images/articles/img-2.png') }}"
                                                            alt=""
                                                            class="img-fluid d-block"/>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img
                                                            src="{{ asset('theme/admin/assets/images/articles/img-3.png') }}"
                                                            alt=""
                                                            class="img-fluid d-block"/>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img
                                                            src="{{ asset('theme/admin/assets/images/articles/img-4.png') }}"
                                                            alt=""
                                                            class="img-fluid d-block"/>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img
                                                            src="{{ asset('theme/admin/assets/images/articles/img-5.png') }}"
                                                            alt=""
                                                            class="img-fluid d-block"/>
                                                    </div>
                                                    <div>
