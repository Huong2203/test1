                ...
                <div class="col-lg-9 mx-auto">
                    ...
                    <ul class="list-inline widget-list-inline">
                        <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-inline-item"><a href="<?php echo e(route('categories.articles', $item->id)); ?>"><?php echo e($item->name); ?></a></li>
            ...
            <div class="row">
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        ...
                        <?php endif; ?>
                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title" href="post-details.html"><?php echo e($articleRandom->title); ?></a></h3>
                    ...
                    <?php $__currentLoopData = $articleHot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="card mb-4">
                            <div class="card-body d-flex">
                                ...
                                <?php endif; ?>
                                <div class="ml-3">
                                    <h4><a href="post-details.html" class="post-title"><?php echo e($item->title); ?></a></h4>
                    ...
                    <article class="card">
                        <div class="card-body">
                            ...
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="<?php echo e(asset('assets/clients/images/kate-stone.jpg')); ?>" alt="Kate Stone">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8  mb-5 mb-lg-0">
                    ...
                    <article class="card mb-4">
                        ...
                        <div class="card-body">
                            <h3 class="mb-3"><a class="post-title" href="post-elements.html"><?php echo e($item->title); ?></a></h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                ...
                <aside class="col-lg-4 sidebar-home">
                    ...
                    <div class="widget widget-about">
                        ...
                        <img class="img-fluid" src="<?php echo e(asset('assets/clients/images/author.jpg')); ?>" alt="Themefisher">
                    ...
                    <!-- Promotion -->
                    <div class="promotion">
                        <img src="<?php echo e(asset('assets/clients/images/promotion.jpg')); ?>" class="img-fluid w-100">
                    ...
                    <div class="widget widget-author">
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="<?php echo e(asset('assets/clients/images/john-doe.jpg')); ?>">
                            </div>
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="<?php echo e(asset('assets/clients/images/kate-stone.jpg')); ?>">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="<?php echo e(asset('assets/clients/images/john-doe.jpg')); ?>" alt="John Doe">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="widget">
                        ...
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="<?php echo e(asset('theme/client/images/post/post-10.jpg')); ?>">
                                <div class="ml-3">
                        ...
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="<?php echo e(asset('theme/client/images/post/post-3.jpg')); ?>">
                                <div class="ml-3">
                        ...
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="<?php echo e(asset('theme/client/images/post/post-7.jpg')); ?>">
                                <div class="ml-3">
                                    <h5><a class="post-title" href="post-details.html">Advice From a Twenty
                                            Something</a></h5>
                                    <ul class="card-meta list-inline mb-0">
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\WebNews\xuong-laravel-main\resources\views/home.blade.php ENDPATH**/ ?>